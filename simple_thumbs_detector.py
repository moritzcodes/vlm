#!/usr/bin/env python3
"""
🎯 Simple Thumbs Up Detector with Google AI Studio
- Uses Google AI Studio (easier setup)
...
def setup_ai_model():
    ...
    try:
        ...
        # Try 2.5 Pro first, fallback to 1.5 Pro
        try:
            model = genai.GenerativeModel('gemini-2.5-pro')
            print("🤖 Google AI Studio Gemini 2.5 Pro loaded")
        except:
            model = genai.GenerativeModel('gemini-1.5-pro')
            print("🤖 Google AI Studio Gemini 1.5 Pro loaded")
        
        return model
        
    except Exception as e:
        print(f"❌ Google AI Studio setup failed: {e}")
        return None
...
1. What do you see? (brief description of people, objects, actions)
2. Is anyone showing a thumbs up gesture? (YES or NO)
...
THUMBS_UP: [YES or NO]"""
    ...
    def add_overlay(self, frame, frame_count):
        ...
        # Frame info
        cv2.putText(frame, f"Frame: {frame_count} | Google AI Studio", (20, 95), 
...
def main():
    print("🎯 Starting Thumbs Up Detector with Google AI Studio")
